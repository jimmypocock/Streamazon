...
class AWSClient:
    ...
    def __init__(self, profile_name: Optional[str] = None, role_arn: Optional[str] = None):
        ...
        self._org_client: Optional[Any] = None
        self._ce_client: Optional[Any] = None
        self._cloudwatch_client: Optional[Any] = None
        self._resource_groups_client: Optional[Any] = None
        ...
        if not self._session:
            if self.profile_name:
                ...
                assumed_role = sts.assume_role(
                    RoleArn=self.role_arn, RoleSessionName="aws-cost-monitor"
                )
    ...
    def get_service_usage_metrics(
        self, service: str, account_id: str, start_time: datetime, end_time: datetime
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_resource_inventory(
        ...
        try:
            ...
            logger.info(
                f"Retrieved {sum(len(resources) for resources in inventory.values())} resources"
            )
            return inventory
    ...
    def parallel_fetch_metrics(
        ...
        def fetch_metrics_for_service_account(
            service: str, account_id: str
        ) -> Tuple[str, str, Any]:
