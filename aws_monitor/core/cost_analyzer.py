...
class CostAnalyzer:
    ...
    def _process_cost_response(self, response: Dict[str, Any], group_by: List[str]) -> Dict[str, Any]:
        ...
        for result in response.get('ResultsByTime', []):
            ...
            for group in result.get('Groups', []):
                ...
                usage = float(group['Metrics']['UsageQuantity']['Amount']) if 'UsageQuantity' in group['Metrics'] else 0
    ...
    def get_cost_trends(self,
        ...
        try:
            ...
            response = self.aws_client.cost_explorer.get_cost_and_usage(
                ...
                Filter=filter_dict
            ) if filter_dict else self.aws_client.get_cost_and_usage(
                start_date=start_date,
                end_date=end_date,
                granularity='DAILY',
                metrics=['UnblendedCost']
            ...
            return {
                ...
                'statistics': {
                    ...
                    'trend': 'increasing' if len(daily_costs) >= 2 and daily_costs[-1] > daily_costs[-7] else 'decreasing'
                },
                'forecast': forecast
            }
